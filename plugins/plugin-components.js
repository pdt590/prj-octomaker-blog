...
Vue.component('v-card-post-mobile', () => import('~/components/CardPostMobile'))
...
Vue.component('v-modal-delete-confirm', () => import('~/components/ModalDeleteConfirm'))
Vue.component('v-modal-discard-confirm', () => import('~/components/ModalDiscardConfirm'))